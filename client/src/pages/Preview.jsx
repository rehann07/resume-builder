    ...
    <div>
      {isLoading ? <Loader /> : (
        <div className='flex flex-col items-center justify-center h-screen'>
          ...
          <a href="/" className='mt-6 bg-green-500 hover:bg-green-600 text-white ronuded-full px-6 h-9 m-1 ring-offset-1 ring-1 ring-green-400 flex items-center transition-colors'>
