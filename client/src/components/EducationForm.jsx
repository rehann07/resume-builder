...
const EducationForm = ({data,onChange}) => {
  ...
  return (
    <div className='space-y-6'>
        ...
        <div>
            <h3 className='flex items-center gap-2 text-lg font-semibold text-gray-900'>Professional Education</h3>
                ...
                data.map((education,index)=>(
                    <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                        ...
                        <div className='grid md:grid-cols-2 gap-3'>
                            ...
                            <input value={education.graduation_date || ""} onChange={(e)=>updateEducation(index,"graduation_date",e.target.value)} type="month" placeholder='' className='px-3 py-2 text-sm '/>
                        </div>
